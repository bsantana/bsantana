...
final class TM_Extra_Product_Options {
	...
	private $tm_plugin_settings=array(
			...
			"tm_epo_no_zero_priced_products" 			=> "no",
			...
			"tm_epo_uploading_files_text" 				=> "",
			"tm_epo_uploading_message_text" 			=> "",
			"tm_epo_select_file_text" 					=> "",
			// Style
			"tm_epo_css_styles" 						=> "",
	...
	public function add_cart_item( $cart_item=array() ) {
		...
		if (floatval(apply_filters('tm_epo_cart_options_prices',$cart_item['data']->price,$cart_item))<0){
