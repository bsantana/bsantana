...
<p style="margin: 0 0 16px;padding: 48px 48px 0 48px;">Olá '.$user_name.',<br><br>
			...
			<div style="position: relative;padding: 0 150px;text-align: center;">
			<p style="background: #cd1f25;padding: 15px;margin: 0;color: #fff;font-size: 18px;"><b>CÓDIGO DO CUPOM:</b></p>
			<p style="border: 2px dashed #cd1f25;margin: 0;right: 21.4%;top: 28%;color: #cd1f25;font-size: 18px;padding: 16px;background: #fff;border-radius: 3px;">'.$coupon_order->post_title.'</p>
			</div><br>
